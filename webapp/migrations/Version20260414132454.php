 ...
 */
final class Version20260414132454 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE chaussette DROP statut');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE chaussette ADD statut TINYINT NOT NULL');
    }
}
